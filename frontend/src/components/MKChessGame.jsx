...
//   const [roomIDSuffix,setRoomIDSuffix]=useState("_MK")
...
//     socket.emit("playOnline", {variantType:"MK"});
//   }
...
//                   <p>Room ID: {roomID.replace(/_(HQ|PP|FB|PHANTOM|MK)$/, '')}</p>
...
function MKChessGame() {
  ...
  // Listen for local board updates in BOT games
  useEffect(() => {
    const handler = (e) => {
