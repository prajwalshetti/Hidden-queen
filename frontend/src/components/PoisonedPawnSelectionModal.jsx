...
const PoisonedPawnSelectionModal = ({ 
  isOpen, 
  playerRole, 
  onSelect
}) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-6 rounded-xl shadow-xl border border-purple-700 max-w-md">
        <h2 className="text-2xl font-bold text-center mb-4 text-purple-400">
          Choose a pawn to be your poisoned pawn
        </h2>
        ...
        <p className="text-sm text-gray-400 text-center mt-2">
          Select which pawn will secretly be your poisoned pawn.
          It will move like a pawn but if captured by your opponent then you win the game.
        </p>
      </div>
    </div>
  );
...
export default PoisonedPawnSelectionModal;